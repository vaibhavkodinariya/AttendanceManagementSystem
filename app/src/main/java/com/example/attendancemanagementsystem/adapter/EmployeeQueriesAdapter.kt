...
class EmployeeQueriesAdapter(private val activity: Activity, private val queries : Array<Queries>):
    ArrayAdapter<Queries>(activity,R.layout.viewquerystudentcardgrid,queries) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        viewHolder.studentname.text="Student Name:- "+queries[position].firstname+" "+ queries[position].lastname
        viewHolder.subjectName.text="Subject Name:- "+queries[position].subjectname
